    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                @csrf   <!-- Directiva de Blade para incluir el token CSRF en el formulario -->
                <!-- CSRF es un token de seguridad que protege el formulario de ataques CSRF (Cross-Site Request Forgery) -->
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input id="email" name= "email" type="email" placeholder="Tu Nombre de Usuario" 
